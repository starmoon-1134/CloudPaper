...
<html lang="en-GB">
    <head>
		...
		<script src="${pageContext.request.contextPath}/js/home/home1.js"></script>
        ...
        <link rel="icon" href="${pageContext.request.contextPath}/images/paper.ico">
...
<%--                     </section> --%>
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/js/home/home2.js"></script>
        <!--<![endif]-->
